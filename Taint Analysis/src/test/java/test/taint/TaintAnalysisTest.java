...
public class TaintAnalysisTest extends IFDSTestSetUp {
    ...
    @Test
    public void FilterShell() {
        JimpleIFDSSolver<?, ? extends InterproceduralCFG<Unit, SootMethod>> analysis = executeStaticAnalysis(target.taint.FilterShell.class.getName());
        Set<String> defaultIDEResult = getResult(analysis);
    }
